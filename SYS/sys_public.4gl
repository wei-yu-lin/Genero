...
#
{  1.normal(�s�W,�d��,�ק�,�R��,�s��,���},����)
   2.full(�s�W,�d��,�e�@��,���@��,�ק�,�R��,�s��,���},����)
   3.full query&update&del(�d��,�e�@��,���@��,�ק�,�R��,�s��,���},����)
   4.query&update&del(�d��,�ק�,�R��,�s��,���},����)
   5.query&update&del&back(�d��,�e�@��,���@��,�ק�,�R��,�s��,���^,���},����)
   6.query&update(�d��,�ק�,�s��,���},����)
   7.query(�d��,���},����)
   8.exit(���})
   9.query&update(�d��,�e�@��,���@��,�ק�,�s��,���},����)
   A.update(�ק�,�s��,���},����) ->�����v����toolbar type
   B.add&update(�s�W,�d��,�e�@��,���@��,�ק�,�s��,���},����)
   C.query&update(�d��,�e�@��,���@��,�ק�,�s��,���},����)
   D.query(�d��,�e�@��,���@��,���},����)
   E.full maintain(�s�W,�d��,�e�@��,���@��,�Ĥ@��,�̫ᵧ,�ק�,�R��,�s��,���},����)
   F.full query(�d��,�e�@��,���@��,�Ĥ@��,�̫ᵧ,���},����)
   G.save(�s��,���},����) ->�����v����toolbar type
   H.add&query&del(�s�W,�d��,�e�@��,���@��,�R��,�s��)
   I.add&query(�s�W,�d��,�e�@��,���@��,�s��)
   J.normal& no del(�s�W,�d��,�ק�,�s��,���},����)
}

#�s�W  1,2,B,E,H,I,J
#�ק�  1,2,3,4,5,6,9,B,C,E,J
#�R��  1,2,3,4,5,E,H
#�d��  1,2,3,4,5,6,7,9,B,C,D,E,F,H,I,J
#�W�U�� 2,3,5,9,B,C,D,E,F,H,I
#�Ĥ@��,�̫ᵧ E,F
...
END FUNCTION 
#------------------------------------------------------------------------
#�ǤJ�r��P_STR�Χ��M�r��t_type�A�^��FIND OR NOTFOUND
#------------------------------------------------------------------------
    ...
    IF SQLCA.sqlcode = 0 AND t_nextdate IS NOT NULL THEN 
         ...
         IF t_type ="m" THEN
           select to_char(add_months(to_date(t_date,'yyyymmdd'),t_int),'yyyymmdd') 
               INTO t_nextdate from dual     
         END IF
    #    �ѤW�O��day*365���@�~,���Y�J���|�G��,�ѼƷ|���Q���������t,�G�אּ�Τ�*12
         IF t_type ="y" THEN
...
DEFINE filename varchar(120),
 ...
 TRY 
     ...
     LET s_pos = buf.getIndexOf(".",1)
      #CALL FGL_WINMESSAGE( "����", "s_pos="||s_pos, "information")
     LET s_length = length(filename)
      #CALL FGL_WINMESSAGE( "����", "s_len="||s_length, "information")
