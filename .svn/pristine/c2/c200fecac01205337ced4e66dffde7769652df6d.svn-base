...
FUNCTION sys_contro_toolbar(channel, t_type)
    ...
    DEFINE
        tb_name_add, tb_name_del, tb_name_upd, tb_name_qry VARCHAR(20),
...
# 改用 CASE的方式來區分
    ...
    CASE t_type
        WHEN "1" #normal(新增,查詢,修改,刪除,存檔,離開,說明)
            ...
            LET tbi =
                createToolBarItem(tb, tb_name_qry, "查詢", "查詢1", "find")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi = createToolBarItem(tb, tb_name_upd, "修改", "修改", "prop")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi =
                createToolBarItem(tb, tb_name_del, "刪除", "刪除", "eraser")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi =
                createToolBarItem(tb, tb_name_save, "存檔", "存檔", "disk")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi = createToolBarItem(tb, "bye", "離開", "離開", "quit")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi =
                createToolBarItem(tb, tb_name_help, "說明", "說明", "quest")
        ...
        WHEN "2" #full(新增,查詢,前一筆,後一筆,修改,刪除,存檔,離開,說明)
            ...
            LET tbi =
                createToolBarItem(
                    tb, tb_name_next, "後一筆", "後一筆", "goforw")
            LET tbs = createToolBarSeparator(tb) ###############
            LET tbi = createToolBarItem(tb, tb_name_upd, "修改", "修改", "prop")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi =
        ...
        WHEN "3" #full query&update&del(查詢,前一筆,後一筆,修改,刪除,存檔,離開,說明)
            LET tbi =
                createToolBarItem(tb, tb_name_qry, "SYS0002", "SYS0011", "find")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi =
                createToolBarItem(
                    tb, tb_name_prev, "SYS0003", "SYS0003", "gorev")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi =
                createToolBarItem(
                    tb, tb_name_next, "SYS0004", "SYS0004", "goforw")
            LET tbs = createToolBarSeparator(tb) ###############
            LET tbi =
                createToolBarItem(tb, tb_name_upd, "SYS0005", "SYS0012", "prop")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi =
                createToolBarItem(
                    tb, tb_name_del, "SYS0006", "SYS0013", "eraser")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi =
                createToolBarItem(
                    tb, tb_name_save, "SYS0007", "SYS0015", "save")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi = createToolBarItem(tb, "bye", "SYS0008", "SYS0008", "quit")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi =
                createToolBarItem(
                    tb, tb_name_help, "SYS0009", "SYS0014", "quest")
        ...
        WHEN "5" #query&update&del&back(查詢,前一筆,後一筆,修改,刪除,存檔,返回,離開,說明)
            ...
            LET tbi =
                createToolBarItem(
                    tb, tb_name_back, "SYS0016", "SYS0017", "uplevel")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi = createToolBarItem(tb, "bye", "SYS0008", "SYS0008", "quit")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi =
        ...
        WHEN "B" #(新增,查詢,前一筆,後一筆,修改,存檔,離開,說明)
            LET tbi =
                createToolBarItem(tb, tb_name_add, "SYS0001", "SYS0010", "new")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi =
                createToolBarItem(tb, tb_name_qry, "SYS0002", "SYS0011", "find")
            LET tbs = createToolBarSeparator(tb) ##############
        ...
        WHEN "E" #(新增,查詢,前一筆,後一筆,第一筆,最後筆,修改,刪除,存檔,離開,說明)
            ...
            LET tbi =
                createToolBarItem(
                    tb, tb_name_first, "SYS0041", "SYS0041", "gorev")
            LET tbs = createToolBarSeparator(tb) ##############
            LET tbi =
                createToolBarItem(
                    tb, tb_name_last, "SYS0042", "SYS0042", "goforw")
            LET tbs = createToolBarSeparator(tb) ###############
            LET tbi =
                createToolBarItem(tb, tb_name_upd, "SYS0005", "SYS0012", "prop")
            LET tbs = createToolBarSeparator(tb) ##############
